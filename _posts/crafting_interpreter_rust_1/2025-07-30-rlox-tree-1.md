...
"1 + 2 * 3"                                                     "7"
```
I have a statement, and I can write an interpreter to let it produce `7` for me. I will end this part here. The [next part](/posts/rlox-tree-2/) will be about making our language more like a language, not the calculator. Currently, my language cannot do sth like `var x=4;`, `if(x==1) ... else ...` yet. I need to extend the grammar to support these things.
