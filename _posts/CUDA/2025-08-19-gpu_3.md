...
Continuing from the [previous part](/posts/cuda-series-part-3-cuda-memory/), which is about CUDA memory layout and coalescing technique, let's continue with the feature allowing us to run several kernels asynchronously.
