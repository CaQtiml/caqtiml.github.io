...
date: 2025-07-05
permalink: /posts/cuda-series-part-2-cuda-programming-model/
...
So, this is the end of this part. The [next part](/posts/cuda-series-part-3-cuda-memory/) will discuss CUDA memory layout and coalescing technique that can help make your CUDA program even faster.
...
This blog is originally published in [Medium](https://caqtiml.medium.com/cuda-series-part-2-cuda-programming-model-9c16fe497753).

This blog is inspired from Lecture 4 of Low-Level Parallel Programming course offered by Uppsala University.  